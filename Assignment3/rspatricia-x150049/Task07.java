...
public class Task07
{
	...
	public static void main(String args[])
	{
		...
		while (instances.hasNext()) { 
            ...
            System.out.println("Instance of a Person: " + inst.getURI()); 
        } 
		...
		while (subclasses.hasNext()) { 
            ...
            System.out.println("Subclass of a Person: " + subclass.getURI()); 
        } 
        ...
        //Imprimir las subclases y las instancias de cada una de las subclases
